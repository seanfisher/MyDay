...
"undefined" == typeof module && (exports = this);
...
exports.OAuth = function(global) {
    ...
    function Request() {
        var XHR;
        if ("undefined" != typeof Titanium && "undefined" != typeof Titanium.Network.createHTTPClient) {
            XHR = Titanium.Network.createHTTPClient();
            return XHR;
        }
        if ("undefined" != typeof global.Titanium && "undefined" != typeof global.Titanium.Network.createHTTPClient) XHR = global.Titanium.Network.createHTTPClient(); else if ("undefined" != typeof require) try {
            XHR = new require("xhr").XMLHttpRequest();
        } catch (e) {
            if ("undefined" == typeof global.XMLHttpRequest) throw "No valid request transport found.";
    ...
    QueryString.prototype.setQueryParams = function(query) {
        ...
        } else for (i = 0; args_length > i; i += 2) querystring[args[i]] = args[i + 1];
    };
    ...
    OAuth.prototype = {
        ...
        init: function(options) {
            ...
            this.request = function(options) {
                ...
                if (!("Content-Type" in headers && "application/x-www-form-urlencoded" != headers["Content-Type"] || withFile)) for (i in data) signatureData[i] = data[i];
                ...
                oauth.proxyUrl && (url = URI(oauth.proxyUrl + url.path));
